...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public final ResponseEntity<ErrorMessage> handlerAllExceptions(Exception e, WebRequest request){
    ...
    public final ResponseEntity<ErrorMessage> handlerCitiesExceptions(Exception e, WebRequest request){
    ...
    public final ResponseEntity<ErrorMessage> handlerCountryExceptions(Exception e, WebRequest request){
    ...
    @ExceptionHandler(StateNotFound.class)//Aqui o m�todo vai tratar apenas as StateNotFound exception
    public final ResponseEntity<ErrorMessage> handlerStateException(Exception e, WebRequest request){
